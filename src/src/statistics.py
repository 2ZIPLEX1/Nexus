...
class TradingStatistics:
    ...
    def get_summary(self, days: int = 30) -> Dict:
        ...
        try:
            ...
            # total_invested is from sold_items, total_purchases is current holdings
            total_invested_sold = profit_data.get('total_invested', 0.0)
            total_purchases_held = self.db.get_total_purchases_value()
            # Total spent = money spent on sold items + money currently tied in holdings
            total_cost = total_invested_sold + total_purchases_held
